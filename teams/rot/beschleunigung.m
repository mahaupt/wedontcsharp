...
%% Was soll der Spaceball tun?
    ...
    function whatToDo()
        if StartNumberOfTank*0.5 < me.getankt || (norm(me.pos-enemy.pos)<0.5 && me.getankt>enemy.getankt && ~corridorColliding(me.pos, enemy.pos, constNavSecurity))
...
%                 eval = createTankEvaluation(me.pos);
%                 if numel(eval) == 0
%                     return;
%                     
%                 else                     
