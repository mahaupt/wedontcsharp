...
team.mitarbeiter(1).aufgabe = 'Director Of Refueling';

team.mitarbeiter(2).name = 'Marcel Haupt';
team.mitarbeiter(2).aufgabe = 'Director Of Pathfinding';

team.mitarbeiter(3).name = 'Julian Wiggers';
team.mitarbeiter(3).aufgabe = 'Director Of Attack';
